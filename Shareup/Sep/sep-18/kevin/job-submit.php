...
<div class="share-unsuccess">
	<img src="<?php echo get_bloginfo('url');?>/wp-content/uploads/2017/09/share-unsuccessfull.png" alt="share-unsuccessfull" class="aligncenter size-full wp-image-313" />
</div>
<?php
	exit;
}
...
$message="Hello ".$name.",<br> <br>You have successfullly share your job<br><br> Thanks";
      wp_mail($email, 'You have share your job', $message, $headers);
...
?>	
	<div class="share-text">
		<img src="<?php echo get_bloginfo('url');?>/wp-content/uploads/2017/08/share-success.png" alt="" width="" height="" class="aligncenter size-full wp-image-313" />
	</div>
<?php
exit;
}
...
<?php if($response1->state=="authorized")
{?>
  ...
  <div class="text-side8">
    <form name="job_posting" action="" method="post" id="job_posting">
     <div id="sf1" class="frm">
        ...
        <div class="form-group">
        <label>Where do you want to give ?(i.e. your city of residence)</label>
       ...
       <input type="text" name="job_city" id="job_city" class="form-control"  placeholder="Location" required> 
		 ...
		 <br><span id="location_error" class="help-inline-error"></span>
        </div>
...
<div class="clearfix" style="clear: both;"></div>
     <div class="form-group">
       ...
       <div class="form-group">
        <label>Who would you like to give your monetory sid to ?<br>(You can choose to leave this blank, but your inbox requests may be larger than normal) </label>
         <textarea maxlength="140" id="textarea_job" name="description" class="form-control" placeholder="Description"></textarea> 
        ...
        <div class="form-group">
              <div class="col-lg-10 col-lg-offset-3">
                <button class="btn  open1" id="post_submit" type="button">Post to Share</span></button> 
              </div>
            </div>
          </fieldset>
        </div>
		...
		<div class="form-group col-md-6">
			...
			<input id="fullname" class="form-control" name="fullname" value="<?php echo $name; ?>" type="text" readonly placeholder="John Smith" required/>
		</div>
     
		 <div class="form-group col-md-6">
			<label for="inputPassword">Email: </label>
			<input id="email" class="form-control"  name="email" type="email" readonly value="<?php echo $email; ?>" placeholder="johnsmith@examplea.com" required/>
		</div> 
		...
		<div class="form-group col-md-6">
         ...
         <p class="agree">We charge a 12% fee on any and all refunds</p>
         <p class="agree">By posting you agree to our <a href="#">Terms of Use</a> and <a href="#">Privacy Policy</a></p>
      </form>
    </div>
...
<script type="text/javascript">
  jQuery(document).ready(function()
  {
	 ...
	 var city = jQuery("#job_city").val();
		 jQuery.ajax({
                url : '<?php echo get_bloginfo('template_url');?>/check_location.php',               
                type:'post',
				async : false,
				data: {location: city},
...
jQuery('#job_posting1').submit(function () {
	alert("fine");
	
//jQuery('#job_city').change(function () {
