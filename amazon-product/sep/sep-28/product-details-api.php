		...
		$("#price_detail").click(function(){
			...
			if(category_value ==''){
				...
				if(category_value=="345"){
					...
					vat_customes = 0;
					total_fee = parseInt(product_price) + parseInt(website_fee) + parseInt(custome_fee) ;
					...
					vat_customes = product_price*14/100 ;
					total_fee = parseInt(product_price) + parseInt(website_fee) + parseInt(custome_fee) + parseInt(vat_customes) ;
				...
				$("#online_price").text(product_price);
				$("#website_fee").text(website_fee);
				$("#custome_fee").text(custome_fee);
				$("#vat_customs").text(vat_customes);
				if(typeof(clearance_fee) != "undefined" && clearance_fee !== null){
					$("#clearance").text(clearance_fee);
				}
				//if(clearance_fee){$("#clearance").text(clearance_fee);};
				//$("#clearance").text(clearance_fee)
