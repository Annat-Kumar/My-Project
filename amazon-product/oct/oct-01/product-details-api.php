...
.cart-detail{background: #fef4e9 !important;}
</style>
			...
			var url=ajaxUrl;
				...
				{					
					...
					if(price ==''){
						...
						$("#website_fee").text("30% of product price");
						$("#custome_fee").text("depend on product category");
						$("#vat_customs").text("depend on product category");
						$("#clearance").text("depend on product category");
