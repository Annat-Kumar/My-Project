...
//echo $queried_post->post_excerpt;echo "<br>";
//echo $expcerpt;die;
		 ...
		 if (($handle = fopen($full_url, "r")) !== FALSE) 
		{
		  while (($data = fgetcsv($handle, 1000, ";")) !== FALSE) 
			...
			if(!$insert){
					...
					echo "csv data imported sucessfully";
				}
...
<div class="wrap">
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			<button id="myBtn" value="" disabled>Edit</button>
			<button id="delBtn" value="" disabled>Delete</button>
