...
/*    alert('jjjjjjjjjjjjj');*/
  ...
  $('#edit_event_date').datepicker({
    ...
    $('#edit_event_date').datepicker('setStartDate',e.date)
  });
  ...
  $('#edit_event_e__date').datepicker({
    ...
    $('#edit_event_e__date').datepicker('setEndDate',e.date)
  });
...
<script type="text/javascript">
	jQuery(".dropdown-menuw.nested_events a").filter(function(){
    return this.href == location.href.replace(/#.*/, "");
}).addClass("active");
	$('.dropdown-menuw.nested_events').find('li:has(ul)').addClass('parent');



    $('.dropdown-menuw.nested_events li a').each(function(){
    
        if($(this).hasClass('active')) { 
        $(this).addClass("ActivetoogleClick");      
        
        $(this).closest("a li").children(".nested_events").css("display","block");
