...
*/
		...
		$response_e = $wepay_edit->request('/account', array(
			...
			if(isset($_POST['delete_account']))
			{
				...
				{
					 $delete = my_delete_user($user_ids) ;
					if(isset($delete))
					{
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<h6>Your current balance is <?php echo $user_balance;?></h6>
      </div>
      <div class="modal-body">
        ...
        <input type="submit" id="sub_chnge_info" name="chng_submit" class="submit btn btn-success action-button" value="Submit" />
          ...
          <li class="btn_down">
			...
			<!--<a href="#" onclick="if ( ! confirm( 'WARNING!\n\nAre you sure you want to delete user sanjaykumar?' ) ) return false;">Delete Account</a> -->
