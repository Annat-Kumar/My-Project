...
/*	echo "<pre>";
   ...
   // WePay PHP SDK - http://git.io/mY7iQQ
	...
	$access_token = 'STAGE_b9fc2cd7c3527ebe470df4f1a022618cd443c2ae925a46feabfe4fac65424070';
	$account_id = '1980093174';
...
if($response1->state=="authorized" && $response3->state=="authorized")
{
	...
	$Update = $wpdb->query("UPDATE wp_post_relationships SET donor_id = $id WHERE r_id = $rent_id AND f_id = $fund_id ");

		}
		else {
	$Update = $wpdb->query("UPDATE wp_post_relationships SET donor_id = $user_register WHERE r_id = $rent_id AND f_id = $fund_id ");			
	...
	<div class="modal-dialog">
		<div class="modal-content model-cont modelcont-2">
			...
			<div class="modal-body">
				<p class="save-succes">You have successfully donated the amount</p>
			</div>
...
<script>
	$(document).ready(function(){
		...
		$( ".redirect_pge" ).click(function() {
			window.location.href = "<?php echo home_url();?>/user/<?php echo $username?>";
		});
	});
</script>
		...
		<div class="row">
			...
			<div class="col-md-5 col-sm-5 donate_right">
				<div class="donate_border_img">
					...
					<h1><?php echo $_POST['fund_name'];?></h1>
