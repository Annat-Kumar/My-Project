        ...
        <div class="profile_top">
          <div class="col-md-2 col-sm-3 col-xs-12 profile_name tabs_profile profile_left">
            ...
            <div class="img_profiles">
              ...
              <?php } else {?>
              <img src="<?php echo site_url();?>/wp-content/uploads/2017/11/dummy.jpg" class="img-responsive center-block profile-img">
              <?php } ?>
              <?php 
              if(is_user_logged_in())
              { 
                ...
                if($current_user->ID == $user_id || (in_array("administrator", $user_roles)) || (in_array("editor", $user_roles)))
                {
                  ...
                  <div class="col-md-12 col-sm-12 edit_all">
                    <ul class="list-inline list-unstyled profile_buttons">
                      ...
                      <li><a href="https://stage-go.wepay.com/" ><button type="button">Go to the Wepay account</button></a></li>
                      <?php } ?>
                    </ul>
                  </div>
                        ...
                        <div class="post_border">
                          <div class="thumb_image">
                            ...
                            <div class="col-sm-12 col-md-12 post_titl1">
                              <?php $trimtitle = get_the_title(); $shorttitle = wp_trim_words( $trimtitle, $num_words = 5, $more = '… ' );
                ...
                <figure>
                  ...
                  <div class="post_border">
                        <div class="thumb_image">
                          ...
                          <div class="col-sm-12 col-md-12 post_titl1">
                            <?php $trimtitle = $dis_post_name; $shorttitle = wp_trim_words( $trimtitle, $num_words = 5, $more = '… ' );
