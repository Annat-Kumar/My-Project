            ...
            <div class="img_profiles">
              ...
              { 
                ...
                if($current_user->ID == $user_id || (in_array("administrator", $user_roles)) || (in_array("editor", $user_roles)))
                {
                  ?>
                  <div class="camera">
                 <!-- <button id="profile_picture" type="button" class="btn btn-info btn-default qqq" data-toggle="modal" data-target="#edit_profile_popup" data-original-title="" title=""><i class="fa fa-camera" aria-hidden="true"></i></button>-->
				 
				 <button id="profile_picture" type="button" class="btn btn-info btn-default qqq"><i class="fa fa-camera" aria-hidden="true"></i></button>
				 </div>
                  <?php } } ?>
